  ...
  return (
    <div className="h-screen w-screen bg-[#faf8f5] text-[#2c2c2c] font-arabic overflow-y-scroll snap-y snap-mandatory scrollbar-none select-none relative">
      ...
      <div className={`transition-opacity duration-1000 h-full w-full ${isOpen ? "opacity-100" : "opacity-0"}`}>
        ...
        {/* ================= الصفحة الثالثة (تم رفع المحتوى وتوسيع الخريطة) ================= */}
        <section className="min-h-[88vh] w-screen snap-start flex flex-col justify-start items-center px-4 pt-2 pb-2 bg-[#faf8f5]" dir="rtl">
          ...
          <div className="w-full max-w-md space-y-2 my-1 flex flex-col justify-start">
            ...
            <div className="bg-white text-[#2c2c2c] px-3 py-2 text-center rounded-2xl shadow-md border-2 border-[#c5a059]/60 flex flex-col items-center">
              ...
              <span className="text-[10px] text-[#c5a059] font-medium tracking-wide mb-0.5">التاريخ</span>
              <h4 className="text-xs sm:text-sm font-bold text-[#23385e] mb-1">الجمعة ٢١ / ١١ / ١٤٤٧هـ</h4>
              <div className="flex items-center justify-center gap-2 mb-1">
                <span className="w-6 h-[1px] bg-[#c5a059]/60"></span>
                <span className="text-[#c5a059] text-[10px]">✦</span>
                <span className="w-6 h-[1px] bg-[#c5a059]/60"></span>
              </div>
              <p className="text-[10px] text-gray-500 font-medium" dir="ltr">Friday, May 8, 2026</p>
            </div>
            ...
            <div className="bg-white text-[#2c2c2c] px-3 py-2 text-center rounded-2xl shadow-md border-2 border-[#c5a059]/60 flex flex-col items-center">
              ...
              <span className="text-[10px] text-[#c5a059] font-medium tracking-wide mb-0.5">الزمن</span>
              <h4 className="text-xs sm:text-sm font-bold text-[#23385e] mb-1">الساعة الثامنة والنصف - ٨:٣٠ م</h4>
              <div className="flex items-center justify-center gap-2 mb-1">
                <span className="w-6 h-[1px] bg-[#c5a059]/60"></span>
                <span className="text-[#c5a059] text-[10px]">✦</span>
                <span className="w-6 h-[1px] bg-[#c5a059]/60"></span>
              </div>
              <p className="text-[10px] text-gray-500 font-medium" dir="ltr">Half past eight - 8:30 PM</p>
            </div>

            {/* مربع الموقع والخريطة الموسعة */}
            <div className="bg-white text-[#2c2c2c] px-3 py-2 text-center rounded-2xl shadow-md border-2 border-[#c5a059]/60 flex flex-col items-center">
              <div className="mb-0.5">
              ...
              <h4 className="text-xs sm:text-sm font-bold text-[#23385e] mb-0.5">نادي وزارة الداخلية — جيزان</h4>
              ...
              <a href="https://maps.google.com" target="_blank" rel="noreferrer" className="text-[10px] text-[#c5a059] font-bold underline mb-1 inline-block">
                افتتح في الخرائط | Open in Maps
              </a>
              {/* تم تكبير ارتفاع الخريطة لتمتلئ وتغطي الفراغ السفلي بالكامل */}
              <div className="w-full h-40 sm:h-44 rounded-xl overflow-hidden border border-gray-200 shadow-inner relative">
          ...
          <div className="pb-1 mt-1 flex justify-center"><span className="text-[#c5a059] text-xl animate-bounce font-bold">⌄</span></div>
        </section>
