  ...
  return (
    <div className="h-screen w-screen bg-[#faf8f5] text-[#2c2c2c] font-arabic overflow-y-scroll snap-y snap-mandatory scrollbar-none select-none relative">
      ...
      <div className={`transition-opacity duration-1000 h-full w-full ${isOpen ? "opacity-100" : "opacity-0"}`}>
        ...
        {/* ================= الصفحة الثانية ================= */}
        <section className="min-h-[88vh] w-screen snap-start flex flex-col justify-start items-center px-4 bg-[#faf8f5] pt-2 pb-3">
          {/* المخطوطة في الأعلى بمسافة مريحة */}
          <p className="text-4xl sm:text-5xl font-besm text-[#23385e] mb-2 mt-2 drop-shadow-sm text-center" dir="rtl">
+
          </p>

          {/* تم تصغير الحشو الداخلي للمربع (p-4 sm:p-5) وتعديل تباعد النصوص لتكون مريحة وغير مزحومة */}
          <div className="w-full max-w-md bg-white text-[#2c2c2c] p-4 sm:p-5 text-center rounded-2xl shadow-xl border-2 border-[#c5a059]/50 mt-1">
