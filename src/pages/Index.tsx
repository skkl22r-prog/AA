            ...
            <div className="w-full max-w-md flex flex-col items-center my-auto px-4 pt-4 pb-3 z-10">
              ...
              <form onSubmit={handleWhatsAppSubmit} className="w-full space-y-3">
                ...
                <div className="w-full">
                  ...
                  <div className="bg-white border border-[#c5a059]/30 rounded-2xl py-2 px-4 flex items-center shadow-sm">
                    <svg className="w-4 h-4 text-gray-400 ml-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 01.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                    </svg>
                    <input
                      type="tel"
                      required
                ...
                <div className="w-full">
                  ...
                  <div className="bg-white border border-[#c5a059]/30 rounded-2xl py-2 px-4 flex items-center shadow-sm">
                    <svg className="w-4 h-4 text-gray-400 ml-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 11-4 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                    </svg>
                    <select
                      required
                      value={guests}
            ...
            <div className="w-full h-full flex flex-col justify-between items-center relative pt-4 pb-0 overflow-hidden">
              ...
              <div className="w-full shrink-0 z-0 flex items-end justify-center h-[42vh] sm:h-[45vh] overflow-hidden p-0 m-0">
                <img 
                  src={bottomImg} 
                  alt="شخصيات الحفل" 
                  className="w-full h-full object-cover object-bottom block pointer-events-none" 
                />
              </div>
