  ...
  return (
    <div className="h-screen w-screen bg-[#faf8f5] text-[#2c2c2c] font-arabic overflow-y-scroll snap-y snap-mandatory scrollbar-none select-none relative">
      ...
      <div className={`transition-opacity duration-1000 h-full w-full ${isOpen ? "opacity-100" : "opacity-0"}`}>
        ...
        {/* ================= الصفحة الثالثة (مع الأيقونات الذهبية) ================= */}
        <section className="min-h-[88vh] w-screen snap-start flex flex-col justify-end items-center px-4 pt-4 pb-2 bg-[#faf8f5]" dir="rtl">
          <div className="pt-1 mb-auto">
          ...
          <div className="w-full max-w-md space-y-2 my-1 flex flex-col justify-start">
            ...
            {/* مربع التاريخ */}
            <div className="bg-white text-[#2c2c2c] px-3 py-2.5 text-center rounded-2xl shadow-md border-2 border-[#c5a059]/60 flex flex-col items-center">
              <div className="flex items-center gap-1.5 mb-1">
                ...
                <span className="text-[10px] text-[#c5a059] font-medium tracking-wide">التاريخ</span>
              </div>
              <h4 className="text-xs sm:text-sm font-bold text-[#23385e]">الجمعة ٢١ / ١١ / ١٤٤٧هـ</h4>
              <p className="text-[10px] text-gray-500 font-medium mt-0.5 mb-1.5" dir="ltr">Friday, May 8, 2026</p>
            ...
            <div className="bg-white text-[#2c2c2c] px-3 py-2.5 text-center rounded-2xl shadow-md border-2 border-[#c5a059]/60 flex flex-col items-center">
              <div className="flex items-center gap-1.5 mb-1">
                <svg className="w-4 h-4 text-[#c5a059]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                <span className="text-[10px] text-[#c5a059] font-medium tracking-wide">الزمن</span>
              </div>
              <h4 className="text-xs sm:text-sm font-bold text-[#23385e]">الساعة الثامنة والنصف - ٨:٣٠ م</h4>
              <p className="text-[10px] text-gray-500 font-medium mt-0.5 mb-1.5" dir="ltr">Half past eight - 8:30 PM</p>
              <div className="flex items-center justify-center gap-2">
                <span className="w-6 h-[1px] bg-[#c5a059]/60"></span>
                <span className="text-[#c5a059] text-[10px]">✦</span>
                <span className="w-6 h-[1px] bg-[#c5a059]/60"></span>
            ...
            <div className="bg-white text-[#2c2c2c] px-3 py-2.5 text-center rounded-2xl shadow-md border-2 border-[#c5a059]/60 flex flex-col items-center">
              <div className="flex items-center gap-1.5 mb-1">
                ...
                <span className="text-[10px] text-[#c5a059] font-medium tracking-wide">الموقع</span>
              </div>
              <h4 className="text-xs sm:text-sm font-bold text-[#23385e]">نادي وزارة الداخلية — جيزان</h4>
              <p className="text-[10px] text-gray-500 font-medium mb-1.5">Ministry of Interior Club, Jizan</p>
              ...
              <div className="w-full h-36 rounded-xl overflow-hidden border border-gray-200 shadow-inner relative">
          ...
          <div className="pb-1 mt-2 flex justify-center"><span className="text-[#c5a059] text-xl animate-bounce font-bold">⌄</span></div>
        </section>
