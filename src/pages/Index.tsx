...
export default function WeddingInvitation() {
  ...
  <div className="flex flex-col items-center">
    ...
    <h2 className="text-xl sm:text-2xl font-bold text-[#1e293b] my-0 font-sarahhh1">
  ...
  <div className="flex flex-col items-center mt-3">
    <h3 className="text-3xl sm:text-4xl font-bold text-[#c5a059] my-0 font-sarahhh1">
    ...
    <h4 className="text-xl sm:text-2xl font-bold text-[#1e293b] my-0 font-sarahhh1">
      سلطان بن عيد الشمري
    </h4>
  </div>
  ...
  <div className="flex flex-col items-center">
    <p className="text-xs sm:text-sm text-[#c5a059] font-bold mb-1">
      يوم الثلاثاء الموافق ٢٥ . ٤ . ١٤٤٨ هـ
    </p>

    <div className="text-[11px] sm:text-xs text-gray-700 leading-relaxed font-medium max-w-full" dir="ltr">
      <p>
        Abdulaziz bin Salman Al-Atawi has the honor of inviting you to attend
        the wedding celebration of his son,{" "}
        <span className="text-[#c5a059] font-bold">
          Miteb bin Abdulaziz Al-Atawi
        </span>
        , to the daughter of{" "}
        <span className="text-[#c5a059] font-bold">
          Sultan bin Eid Al-Shammari
        </span>
      </p>

      <p className="text-[#c5a059] font-bold mt-1">
        Friday 14 . Agust . 2026
      </p>
    </div>
  </div>
  ...
  <div className="flex flex-col items-center" dir="rtl">
    <p className="text-xs sm:text-sm font-bold text-[#1e293b] my-0">
      وبحضوركم يتم لنا الفرح والسرور
    </p>

    <p className="text-[10px] sm:text-xs text-gray-500 mt-1" dir="ltr">
