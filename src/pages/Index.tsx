...
export default function WeddingInvitation() {
  ...
  <h2 className="text-xl sm:text-2xl font-bold text-[#1e293b] mb-1 font-sarahhh1">
...
<div className="flex flex-col items-center">
  <h3 className="text-3xl sm:text-4xl font-bold text-[#c5a059] font-sarahhh1">
    متعب بن عبدالعزيز العطاوي
  </h3>
  <p className="text-xs sm:text-sm text-gray-500">
    على كريمة
  </p>
  <h4 className="text-xl sm:text-2xl font-bold text-[#1e293b] font-sarahhh1">
    سلطان بن عيد الشمري
  </h4>
</div>
